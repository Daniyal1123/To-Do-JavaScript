...
var addTask = function(){
    ...
    counter += 1
    document.getElementById("item-count").innerHTML = counter;
...
var completeTask = function(){
  ...
  check += 1
  document.getElementById('checking').innerHTML = check
  counter -= 1
  document.getElementById('item-count').innerHTML = counter
...
var bindCompleteItems = function(taskItem, deleteButtonPress){
  ...
  var deleteButton = taskItem.querySelector(".btn-danger");
